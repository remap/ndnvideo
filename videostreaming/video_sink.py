...
if __name__ == '__main__':
	...
	pipeline = gst.parse_launch("""
		v4l2src ! videoscale ! video/x-raw-yuv,width=400,height=300 ! videorate !
		...
		tee name=input
		input. ! queue leaky=1 max-size-buffers=0 max-size-bytes=0 max-size-time=5000000000 ! ffmpegcolorspace ! ximagesink
